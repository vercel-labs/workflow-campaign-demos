...
| Demo | What it demonstrates | When to use |
|------|----------------------|-------------|
...
| **`fan-out`** | One trigger fans out to parallel branches (often paired with gather/aggregate). | Broadcast an incident alert to Slack, email, SMS, and PagerDuty in parallel. |
