...
import { ChoreographyDemo } from "@/app/components/demos/choreography-demo";
...
const SLUG = "choreography";

export const choreographyAdapter: DemoAdapter = {
  slug: SLUG,
  title: "Choreography",
  ...
  async renderDemo() {
    ...
    return createElement(ChoreographyDemo);
  },

  async getCodeBundle(): Promise<DemoCodeFile[]> {
    const files: DemoCodeFile[] = [
      {
        path: `${SLUG}/workflows/choreography.ts`,
        role: "workflow",
        contents: readDemoFile(SLUG, "workflows/choreography.ts"),
      },
      {
      ...
      {
        path: `${SLUG}/app/components/choreography-code-workbench.tsx`,
        role: "support",
        contents: readDemoFile(SLUG, "app/components/choreography-code-workbench.tsx"),
      },
      {
        path: `${SLUG}/app/api/choreography/route.ts`,
        role: "api",
        contents: readDemoFile(SLUG, "app/api/choreography/route.ts"),
      },
      {
  ...
  apiRoutes: [
    {
      ...
      kind: "start",
      load: () => import("@/app/api/choreography/route"),
    },
    {
