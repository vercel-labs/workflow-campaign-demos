...
export function getMessageTranslatorCodeProps(): Record<string, unknown> {
  ...
  return {
    ...
    workflowLineMap: {
      ...
      "detect": findBestGeneratedRange(workflowCode, "detect", workflowFallbackLines),
      "done": findBestGeneratedRange(workflowCode, "done", workflowFallbackLines),
      "translate": findBestGeneratedRange(workflowCode, "translate", workflowFallbackLines),
      "validate": findBestGeneratedRange(workflowCode, "validate", workflowFallbackLines),
    },
    stepLineMap: {
      "deliverMessage": findBestGeneratedRange(secondaryCode, "deliverMessage", secondaryFallbackLines),
      "detectSourceFormat": findBestGeneratedRange(secondaryCode, "detectSourceFormat", secondaryFallbackLines),
      "translateFields": findBestGeneratedRange(secondaryCode, "translateFields", secondaryFallbackLines),
      "validateOutput": findBestGeneratedRange(secondaryCode, "validateOutput", secondaryFallbackLines),
    },
  };
}
