...
export function getNamespacedStreamsCodeProps(): Record<string, unknown> {
  ...
  return {
    ...
    workflowLineMap: {
      "buildOutlineCall": workflowAllLines,
      "draftWriteLines": workflowAllLines,
      "returnLine": workflowAllLines,
      "telemetryDoneLine": workflowAllLines,
      "telemetryStartLine": workflowAllLines,
      "telemetryWriteLines": workflowAllLines,
      "writeSectionsCall": workflowAllLines,
    },
    stepCode: secondaryCode,
    stepHtmlLines: secondaryHtmlLines,
    stepLineMap: {
      "buildOutlineBody": secondaryAllLines,
      "writeSectionsBody": secondaryAllLines,
    },
  };
}
