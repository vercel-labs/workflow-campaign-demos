...
export function getScheduledDigestCodeProps(): Record<string, unknown> {
  ...
  return {
    ...
    workflowLineMap: {
      "createToken": findBestGeneratedRange(workflowCode, "createToken", workflowFallbackLines),
      "pushEvent": findBestGeneratedRange(workflowCode, "pushEvent", workflowFallbackLines),
      "raceLoop": findBestGeneratedRange(workflowCode, "raceLoop", workflowFallbackLines),
      "returnEmpty": findBestGeneratedRange(workflowCode, "returnEmpty", workflowFallbackLines),
      "returnSent": findBestGeneratedRange(workflowCode, "returnSent", workflowFallbackLines),
      "sendDigest": findBestGeneratedRange(workflowCode, "sendDigest", workflowFallbackLines),
    },
    stepCode: secondaryCode,
    stepHtmlLines: secondaryHtmlLines,
    stepLineMap: {
      "returnLine": findBestGeneratedRange(secondaryCode, "returnLine", secondaryFallbackLines),
      "sendBody": findBestGeneratedRange(secondaryCode, "sendBody", secondaryFallbackLines),
    },
  };
}
