...
export function getWakeableReminderCodeProps(): Record<string, unknown> {
  ...
  return {
    ...
    workflowLineMap: {
      "cancelReturn": findBestGeneratedRange(workflowCode, "cancelReturn", workflowFallbackLines),
      "createHook": findBestGeneratedRange(workflowCode, "createHook", workflowFallbackLines),
      "sendEmail": findBestGeneratedRange(workflowCode, "sendEmail", workflowFallbackLines),
      "sentReturn": findBestGeneratedRange(workflowCode, "sentReturn", workflowFallbackLines),
      "sleepAndRace": findBestGeneratedRange(workflowCode, "sleepAndRace", workflowFallbackLines),
    },
    stepCode: secondaryCode,
    stepHtmlLines: secondaryHtmlLines,
    stepLineMap: {
      "body": findBestGeneratedRange(secondaryCode, "body", secondaryFallbackLines),
    },
  };
}
