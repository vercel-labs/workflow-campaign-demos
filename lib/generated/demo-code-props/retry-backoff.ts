...
export function getRetryBackoffCodeProps(): Record<string, unknown> {
  ...
  return {
    ...
    workflowLineMap: {
      "attempt": findBestGeneratedRange(workflowCode, "attempt", workflowFallbackLines),
      "failureReturn": findBestGeneratedRange(workflowCode, "failureReturn", workflowFallbackLines),
      "sleep": findBestGeneratedRange(workflowCode, "sleep", workflowFallbackLines),
    ...
    stepLineMap: {
      "attempt": findBestGeneratedRange(secondaryCode, "attempt", secondaryFallbackLines),
      "successReturn": findBestGeneratedRange(secondaryCode, "successReturn", secondaryFallbackLines),
    },
  };
}
