...
export function getPublishSubscribeCodeProps(): Record<string, unknown> {
  ...
  return {
    ...
    workflowLineMap: {
      ...
      "filter": workflowAllLines,
      "register": workflowAllLines,
      "summarize": workflowAllLines,
    },
    stepLineMap: {
      "deliverToSubscribers": secondaryAllLines,
      "filterSubscribers": secondaryAllLines,
      "registerSubscribers": secondaryAllLines,
      "summarizeDelivery": secondaryAllLines,
    },
  };
}
