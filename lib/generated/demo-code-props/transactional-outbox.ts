...
export function getTransactionalOutboxCodeProps(): Record<string, unknown> {
  ...
  return {
    ...
    workflowLineMap: {
      "markSentCall": workflowAllLines,
      "persistCall": workflowAllLines,
      "publishCall": workflowAllLines,
      "relayCall": workflowAllLines,
    },
    stepLineMap: {
      "markSentCall": secondaryAllLines,
      "persistCall": secondaryAllLines,
      "publishCall": secondaryAllLines,
      "relayCall": secondaryAllLines,
    },
  };
}
