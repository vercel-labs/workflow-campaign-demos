...
export function getStatusPollerCodeProps(): Record<string, unknown> {
  ...
  return {
    ...
    workflowLineMap: {
      "poll": findBestGeneratedRange(workflowCode, "poll", workflowFallbackLines),
      ...
      "timeoutReturn": findBestGeneratedRange(workflowCode, "timeoutReturn", workflowFallbackLines),
    },
    stepCode: secondaryCode,
    stepHtmlLines: secondaryHtmlLines,
    stepLineMap: {
      "poll": findBestGeneratedRange(secondaryCode, "poll", secondaryFallbackLines),
