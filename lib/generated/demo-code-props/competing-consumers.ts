...
export function getCompetingConsumersCodeProps(): Record<string, unknown> {
  const source = readFileSync(join(process.cwd(), "competing-consumers/workflows/competing-consumers.ts"), "utf-8");
  ...
  return {
    ...
    stepLineMap: {
      ...
      "recordResults": findBestGeneratedRange(secondaryCode, "recordResults", secondaryFallbackLines),
    },
  };
}
