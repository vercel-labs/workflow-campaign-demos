...
export type CorrelationCodeWorkbenchProps = {
  workflowCode: string;
...
export function CorrelationCodeWorkbench({
  workflowCode,
  workflowLinesHtml,
  workflowActiveLines,
  workflowGutterMarks,
  ...
  stepGutterMarks,
  tone,
}: CorrelationCodeWorkbenchProps) {
  return (
    <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
      <CodePane
        code={workflowCode}
        filename="workflows/correlation-identifier.ts"
