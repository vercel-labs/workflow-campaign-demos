...
import { ResequencerCodeWorkbench } from "@/resequencer/app/components/resequencer-code-workbench";
...
const demoProps = {
  ...
  stepHtmlLines: [],
  stepLineMap: {},
} as unknown as Parameters<typeof ResequencerDemo>[0];

export default function ResequencerNativeDemo() {
  return <ResequencerDemo {...demoProps} />;
}
