...
import { RecipientListCodeWorkbench } from "@/recipient-list/app/components/recipient-list-code-workbench";
...
const demoProps = {
  ...
  stepRetryLineMap: {},
  stepSuccessLineMap: {},
} as unknown as Parameters<typeof RecipientListDemo>[0];

export default function RecipientListNativeDemo() {
  return <RecipientListDemo {...demoProps} />;
}
