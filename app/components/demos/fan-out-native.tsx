...
import { FanOutCodeWorkbench } from "@/fan-out/app/components/fanout-code-workbench";
...
const demoProps = {
  ...
  stepRetryLineMap: {},
  stepSuccessLineMap: {},
} as unknown as Parameters<typeof FanOutDemo>[0];

export default function FanOutNativeDemo() {
  return <FanOutDemo {...demoProps} />;
}
