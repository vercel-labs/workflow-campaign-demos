...
import { DigestCodeWorkbench } from "@/scheduled-digest/app/components/digest-code-workbench";
...
const demoProps = {
  ...
  stepHtmlLines: [],
  stepLineMap: {},
} as unknown as Parameters<typeof ScheduledDigestDemo>[0];

export default function ScheduledDigestNativeDemo() {
  return <ScheduledDigestDemo {...demoProps} />;
}
