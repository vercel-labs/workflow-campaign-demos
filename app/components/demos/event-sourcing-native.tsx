...
import { ESCodeWorkbench } from "@/event-sourcing/app/components/es-code-workbench";
...
const demoProps = {
  ...
  workflowLineMap: {},
  stepLineMap: {},
} as unknown as Parameters<typeof EventSourcingDemo>[0];

export default function EventSourcingNativeDemo() {
  return <EventSourcingDemo {...demoProps} />;
}
