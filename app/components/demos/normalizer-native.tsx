...
import { NormalizerCodeWorkbench } from "@/normalizer/app/components/normalizer-code-workbench";
...
const demoProps = {
  ...
  workflowLineMap: {},
  stepLineMap: {},
} as unknown as Parameters<typeof NormalizerDemo>[0];

export default function NormalizerNativeDemo() {
  return <NormalizerDemo {...demoProps} />;
}
