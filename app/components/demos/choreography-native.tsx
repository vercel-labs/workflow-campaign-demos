...
import {
  ...
  type GutterMarkKind,
  type HighlightTone,
} from "@/choreography/app/components/choreography-code-workbench";
...
const demoProps = {
  ...
  participantHtmlLines: [],
  participantLineMap: {},
} as unknown as Parameters<typeof ChoreographyDemo>[0];

export default function ChoreographyNativeDemo() {
  return <ChoreographyDemo {...demoProps} />;
}
