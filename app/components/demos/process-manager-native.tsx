...
import {
  ...
  type GutterMarkKind,
  type HighlightTone,
} from "@/process-manager/app/components/process-manager-code-workbench";
...
const demoProps = {
  ...
  stepHtmlLines: [],
  stepLineMap: {},
} as unknown as Parameters<typeof ProcessManagerDemo>[0];

export default function ProcessManagerNativeDemo() {
  return <ProcessManagerDemo {...demoProps} />;
}
