...
import { QueueCodeWorkbench } from "@/priority-queue/app/components/queue-code-workbench";
...
const demoProps = {
  ...
  workflowLineMap: {},
  stepLineMap: {},
} as unknown as Parameters<typeof PriorityQueueDemo>[0];

export default function PriorityQueueNativeDemo() {
  return <PriorityQueueDemo {...demoProps} />;
}
