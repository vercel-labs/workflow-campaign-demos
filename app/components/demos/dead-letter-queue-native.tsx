...
import { DLQCodeWorkbench } from "@/dead-letter-queue/app/components/dlq-code-workbench";
...
const demoProps = {
  ...
  workflowLineMap: {},
  stepLineMap: {},
} as unknown as Parameters<typeof DLQDemo>[0];

export default function DeadLetterQueueNativeDemo() {
  return <DLQDemo {...demoProps} />;
}
