...
import { CCCodeWorkbench } from "@/competing-consumers/app/components/cc-code-workbench";
...
const demoProps = {
  ...
  workflowLineMap: {},
  stepLineMap: {},
} as unknown as Parameters<typeof CCDemo>[0];

export default function CompetingConsumersNativeDemo() {
  return <CCDemo {...demoProps} />;
}
