...
import { TranslatorCodeWorkbench } from "@/message-translator/app/components/translator-code-workbench";
...
const demoProps = {
  ...
  workflowLineMap: {},
  stepLineMap: {},
} as unknown as Parameters<typeof MessageTranslatorDemo>[0];

export default function MessageTranslatorNativeDemo() {
  return <MessageTranslatorDemo {...demoProps} />;
}
