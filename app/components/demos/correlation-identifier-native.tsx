...
import { CorrelationCodeWorkbench } from "@/correlation-identifier/app/components/correlation-code-workbench";
...
const demoProps = {
  ...
  workflowLineMap: {},
  stepLineMap: {},
} as unknown as Parameters<typeof CorrelationIdentifierDemo>[0];

export default function CorrelationIdentifierNativeDemo() {
  return <CorrelationIdentifierDemo {...demoProps} />;
}
