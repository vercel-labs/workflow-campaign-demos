...
import { BulkheadCodeWorkbench } from "@/bulkhead/app/components/bulkhead-code-workbench";
...
const demoProps = {
  ...
  workflowLineMap: {},
  stepLineMap: {},
} as unknown as Parameters<typeof BulkheadDemo>[0];

export default function BulkheadNativeDemo() {
  return <BulkheadDemo {...demoProps} />;
}
