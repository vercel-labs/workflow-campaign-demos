...
import { SplitterCodeWorkbench } from "@/splitter/app/components/splitter-code-workbench";
...
const demoProps = {
  ...
  workflowLineMap: {},
  stepLineMap: {},
} as unknown as Parameters<typeof SplitterDemo>[0];

export default function SplitterNativeDemo() {
  return <SplitterDemo {...demoProps} />;
}
