...
import { WakeableReminderCodeWorkbench } from "@/wakeable-reminder/app/components/wakeable-reminder-code-workbench";
...
const demoProps = {
  ...
  stepHtmlLines: [],
  stepLineMap: {},
} as unknown as Parameters<typeof WakeableReminderDemo>[0];

export default function WakeableReminderNativeDemo() {
  return <WakeableReminderDemo {...demoProps} />;
}
