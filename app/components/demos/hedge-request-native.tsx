...
import { QueueCodeWorkbench } from "@/hedge-request/app/components/queue-code-workbench";
...
const demoProps = {
  ...
  workflowLineMap: {},
  stepLineMap: {},
} as unknown as Parameters<typeof HedgeRequestDemo>[0];

export default function HedgeRequestNativeDemo() {
  return <HedgeRequestDemo {...demoProps} />;
}
