...
import { RequestReplyCodeWorkbench } from "@/request-reply/app/components/request-reply-code-workbench";
...
const demoProps = {
  ...
  workflowLineMap: {},
  stepLineMap: {},
} as unknown as Parameters<typeof RequestReplyDemo>[0];

export default function RequestReplyNativeDemo() {
  return <RequestReplyDemo {...demoProps} />;
}
