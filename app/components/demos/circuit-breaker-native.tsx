...
import { CircuitCodeWorkbench } from "@/circuit-breaker/app/components/circuit-code-workbench";
...
const demoProps = {
  ...
  stepHtmlLines: [],
  stepLineMap: {},
} as unknown as Parameters<typeof CircuitBreakerDemo>[0];

export default function CircuitBreakerNativeDemo() {
  return <CircuitBreakerDemo {...demoProps} />;
}
