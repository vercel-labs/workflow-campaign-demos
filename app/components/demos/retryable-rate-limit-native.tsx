...
import { RateLimitCodeWorkbench } from "@/retryable-rate-limit/app/components/retryable-rate-limit-code-workbench";
...
const demoProps = {
  ...
  stepHtmlLines: [],
  stepLineMap: {},
} as unknown as Parameters<typeof RateLimitDemo>[0];

export default function RetryableRateLimitNativeDemo() {
  return <RateLimitDemo {...demoProps} />;
}
