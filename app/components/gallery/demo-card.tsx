  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center justify-between gap-3">
        <span className="rounded-full border border-gray-300 px-2 py-0.5 text-[10px] font-mono text-blue-700">
          pattern
        </span>
      ...
      <h3 className="text-[15px] font-semibold leading-snug text-gray-1000 transition-colors duration-150 group-hover:text-blue-700">
        {demo.title}
      </h3>
      <p className="mt-2 line-clamp-2 text-xs leading-relaxed text-gray-900">
        {demo.description}
      </p>
