...
export const metadata: Metadata = {
  title: "Splitter - Workflow DevKit Example",
  description:
    "Demonstrates the Splitter pattern: decomposing a composite order into individual line items for per-item processing.",
};
