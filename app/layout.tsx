...
export const metadata: Metadata = {
  title: "Async Request-Reply — Workflow DevKit Example",
  description:
    "Demonstrates the async request-reply pattern with correlation IDs, vendor callbacks, and durable timeout handling.",
};
