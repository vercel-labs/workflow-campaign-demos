...
export const metadata: Metadata = {
  title: "Choreography - Workflow DevKit Example",
  description:
    "Demonstrates event-driven choreography where independent participants collaborate without a central coordinator.",
};
