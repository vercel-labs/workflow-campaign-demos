...
export const metadata: Metadata = {
  title: "Guaranteed Delivery - Workflow DevKit Example",
  description:
    "Demonstrates durable message delivery with persist-send-ack handshake and automatic retry using workflows.",
};
