...
export const metadata: Metadata = {
  title: "Hedge Request - Workflow DevKit Example",
  description:
    "Demonstrates hedged requests — send the same request to multiple providers concurrently and use the fastest response.",
};
