...
/**
 * V6 — API Gallery (iterated)
 *
 * - Scenario prompts up top to guide first-time visitors
 * - API filter strip (only the 6 interesting APIs, no directives/universal)
 * - Search bar
 * - Cards with fingerprint dots + "when to use" + API pills
 */

// Scenario quick-starts: common questions a visitor might have
const scenarios = [
  {
...
// Only the 6 non-universal APIs for filtering
    ...
    <main className="min-h-screen px-6 pt-20 pb-20 mx-auto max-w-7xl">
      ...
      <header className="mb-10 mt-6 text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-gray-1000/70">
          ...
          action. Pick a scenario below, or filter by API to see how primitives
          compose.
        </p>
      </header>
      ...
      {/* API filter strip — only the 6 interesting APIs */}
