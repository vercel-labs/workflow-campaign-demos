...
export const metadata: Metadata = {
  title: "Message History - Workflow DevKit Example",
  description:
    "Demonstrates the Message History pattern: a structured history array travels through every workflow step for full observability.",
};
