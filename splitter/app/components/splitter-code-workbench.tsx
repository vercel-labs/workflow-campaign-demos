...
type SplitterCodeWorkbenchProps = {
  workflowCode: string;
...
export function syncPreviousSplitterGutterMarks({
  previousMarks,
  gutterMarkMap,
  gutterMarkCount,
  activeLineCount,
...
function CodePane({
  ...
  useEffect(() => {
    ...
    syncPreviousSplitterGutterMarks({
...
export function SplitterCodeWorkbench({
  workflowCode,
  workflowLinesHtml,
  workflowActiveLines,
  workflowGutterMarks,
  ...
  stepGutterMarks,
  tone,
}: SplitterCodeWorkbenchProps) {
  return (
    <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
      <CodePane
        code={workflowCode}
        filename="workflows/order-splitter.ts"
