...
export function syncPreviousFilterGutterMarks({
  previousMarks,
  gutterMarkMap,
  gutterMarkCount,
  activeLineCount,
...
export function FilterCodeWorkbench({
  workflowCode,
  workflowLinesHtml,
  workflowActiveLines,
  workflowGutterMarks,
  ...
  stepGutterMarks,
  tone,
}: FilterCodeWorkbenchProps) {
  return (
    <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
      <CodePane
        code={workflowCode}
        filename="workflows/order-filter.ts"
