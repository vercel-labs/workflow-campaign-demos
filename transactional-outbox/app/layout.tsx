...
export const metadata: Metadata = {
  title: "Transactional Outbox - Workflow DevKit Example",
  description:
    "Demonstrates the transactional outbox pattern with atomic database writes and reliable message publishing.",
};
