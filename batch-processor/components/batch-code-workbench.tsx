...
function CodePane({
  ...
  // Preserve prior icon shape/color when marks fade out.
  for (const [lineStr, kind] of Object.entries(gutterMarks)) {
    const line = Number(lineStr);
    if (!Number.isNaN(line)) {
      prevMarkRef.current[line] = kind;
    }
  }
...
export function BatchCodeWorkbench(props: CodeWorkbenchProps) {
  return (
