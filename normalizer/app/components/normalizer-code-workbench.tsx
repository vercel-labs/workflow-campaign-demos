...
type NormalizerCodeWorkbenchProps = {
  workflowCode: string;
...
export function syncPreviousNormalizerGutterMarks({
  previousMarks,
  gutterMarkMap,
  gutterMarkCount,
  activeLineCount,
...
function CodePane({
  ...
  useEffect(() => {
    ...
    syncPreviousNormalizerGutterMarks({
...
export function NormalizerCodeWorkbench({
  workflowCode,
  workflowLinesHtml,
  workflowActiveLines,
  workflowGutterMarks,
  ...
  stepGutterMarks,
  tone,
}: NormalizerCodeWorkbenchProps) {
  return (
    <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
      <CodePane
        code={workflowCode}
        filename="workflows/normalizer.ts"
